def get_duplicates(playlist1_tracks, playlist2_tracks=None):
    ...
    def process_tracks(tracks, playlist_key):
        ...
        """Helper function to process tracks and populate playlist_details."""
        for track in tracks:
            preview_url = track.get('preview_url')
            if not preview_url:
                continue

            # If the preview_url is not in playlist_details, instantiate it
            ...
            # Append the current track's album and type to the correct playlist's arrays
